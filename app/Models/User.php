...
class User extends Authenticatable
{
    ...
    public function followersProfiles(): HasMany
    {
        return $this->hasMany(FollowersProfile::class, 'profile_user_id', 'id');
    }

    public function popularityProfiles(): HasMany
    {
        return $this->hasMany(PopularityProfile::class, 'user_id', 'id');
    }
}
